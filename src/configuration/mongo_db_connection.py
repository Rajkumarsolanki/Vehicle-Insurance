    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        ...
        try:
            ...
            if MongoDBClient.client is None:
                mongo_db_url = os.getenv(MONGODB_URL_KEY) # Retrieve MongoDB URL for environment variables
                if mongo_db_url is None:
                    raise Exception(f"Enivronment variable '{MONGODB_URL_KEY} is not set.")
