...
class DataValidation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact, data_validation_config: DataValidationConfig):
        ...
        :param data_validatoin_config: configuration for data validation
        """
        try:
    ...
    def initate_data_validation(self) -> DataValidationArtifact:
        """
        Method Name: initate_data_validation
        ...
        try:
            ...
            logging.info("Data validation artifact created and save to JSON file.")
