...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        try:
            ...
            logging.info("Transformers Initialized: StanderScaler-MinMaxScaler")

            #Load schema configuration
            nums_features = self._schema_config['num_features']
            ...
            preprocessor = ColumnTransformer(
                transformers=[
                    ("StandardScaler", numeric_transformer, nums_features),
            ...
            final_pipeline = Pipeline(steps=[("Prespocessor", preprocessor)])
    ...
    def _map_gender_column(self, df):
        ...
        logging.info("Mapping 'Gender' column in binary values")
    ...
    def _rename_columns(self, df):
        ...
        df = df.rename(columns={
            ...
            "Vehcile_Age_> 2 Years" : "Vehicle_Age_gt_2_Years"
        })
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            # Apply customer transformation in specified sequence
            ...
            logging.info("Apply SMOTEENN for handling imbalanced dataset.")
