...
class DataIngestionConfig:
    ...
    training_file_path: str = os.path.join(data_ingestion_dir, DATA_INGESTION_INGESTION_DIR, TRAIN_FILE_NAME)
    testing_file_path: str = os.path.join(data_ingestion_dir,DATA_INGESTION_INGESTION_DIR, TEST_FILE_NAME)
